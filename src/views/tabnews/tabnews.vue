 ...
 * @LastEditTime: 2019-07-29 17:18:20
 -->
<template>
  <div class="tabnews-wrap">
            ...
            <cube-slide-item>
              <cube-scroll :data="followersData" :options="scrollOptions">
                <ul class="list-wrapper">
                  <li
                    v-for="(item, index) in followersData"
                    class="list-item"
                    :key="index"
                  >
                    <div class="top">
              ...
              <cube-scroll :data="recommendData" :options="scrollOptions">
                <ul class="list-wrapper">
                  ...
                  >
                    ...
                    <div class="middle is-grey line-height">
                      {{ item.content }}
                    </div>
                    <div>{{ resolveQuestionFollowers(item) }}</div>
                  </li>
...
<script lang="ts" src="./tabnews.ts"></script>
